  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center justify-between gap-2 w-full md:w-auto min-w-[180px] max-w-[280px] px-3 py-1.5 rounded-md border border-line-strong bg-surface hover:border-accent-500/60 transition-colors"
      >
